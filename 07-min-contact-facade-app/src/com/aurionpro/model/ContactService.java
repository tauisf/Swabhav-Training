...
public class ContactService {
	...
	private  void manageUserContacts(User selectedUser) {
	...
	// Add Contact
		...
		private  void removeMobileNumbers(Contact contact) {
		...
		private  void removeEmailAddresses(Contact contact) {
		...
		// Upadte contact
		private  void updateContact(User user) {
			if (user.getContacts().isEmpty()) {
				System.out.println("No contacts found.");
				return;
			}
		...
		private  void updateMobileNumbers(Contact contact) {
